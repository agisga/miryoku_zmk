...
&kp BSPC,          U_CUT,             U_CPY,             U_PST,             &kp DEL,           U_NA,              &to U_NAV,         &to U_NUM,         U_NA,              U_NA,              \
...
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              &to U_NAV,         &to U_NUM,         U_NA,              U_NA,              \
...
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              &to U_MOUSE,       &to U_SYM,         U_NA,              U_NA,              \
...
&u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       &u_out_tog,        U_NA,              &to U_MEDIA,       &to U_FUN,         U_NA,              U_NA,              \
