...
U_NP,              U_NP,              U_LT(U_FUN, DEL),  &sl U_NUM,         &td_skq LSHFT,     U_LT(U_MOUSE, SPC),U_LT(U_NAV, SPC),  U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_NP,              U_NP,              &kp DEL,           &sl U_NUM,         &td_skq LSHFT,     &kp SPC,           &kp SPC,           &kp ESC,           U_NP,              U_NP
...
&kp BSPC,          U_CUT,             U_CPY,             U_PST,             &kp DEL,           U_NA,              &u_to_U_NAV,       &u_to_U_NUM,       &kp RALT,          U_NA,              \
...
&kp QMARK,         &kp SLASH,         &kp TAB,           &kp TD(U_TD_U_BASE),&kp COLON,         &kp LBKT,          &kp NUM_7,         &kp NUM_8,         &kp NUM_9,         &kp RBKT,          \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         &kp SEMI,          &kp EQL,           &kp NUM_1,         &kp NUM_2,         &kp NUM_3,         &kp NUM_0,         \
...
U_NA,              &kp RALT,          &kp LC(LG(LEFT)),  &kp LC(LG(RIGHT)), U_NA,              &kp PIPE,          &kp DLLR,          &kp PRCT,          &kp CRRT,          &kp TILDE,         \
...
U_BOOT,            &u_to_U_TAP,       U_NA,              &u_to_U_BASE,      U_NA,              &kp PSCRN,         &kp F7,            &kp F8,            &kp F9,            &kp F12,           \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &kp SLCK,          &kp F1,            &kp F2,            &kp F3,            &kp F10,           \
U_NA,              &kp RALT,          &kp LC(LG(LEFT)),  &kp LC(LG(RIGHT)), U_NA,              &kp PAUSE_BREAK,   &kp F4,            &kp F5,            &kp F6,            &kp F11,           \
...
&kp COLONQ,        &kp COLONWQ,       &kp COLONQEX,      U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              &kp LPAR,          &kp RPAR,          \
&kp RA(Q),         &kp RA(P),         &kp RA(S),         &kp RA(Y),         U_NU,              U_NU,              U_NU,              U_NU,              &kp LPAR,          &kp RPAR           \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NU,              U_NU,              U_NU,              &kp LPAR,          &kp RPAR           \
